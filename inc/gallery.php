...
*/
  ...
  function gallery_metabox_enqueue($hook) {
    if ( 'post.php' == $hook || 'post-new.php' == $hook ) {
      wp_enqueue_script('gallery-metabox', get_template_directory_uri() . '/dist/js/gallery-metabox.js', array('jquery', 'jquery-ui-sortable'));
      wp_enqueue_style('gallery-metabox', get_template_directory_uri() . '/dist/css/gallery-metabox.css');
    }
  }
  ...
  function print_gallery_slide_script(){
    echo "<script type=\"text/javascript\">
    jQuery(document).ready(function($) {
      $('.quarto-gallery').slick({
        autoplay: true,
        autoplaySpeed: 4000,
        adaptiveHeight: true,
        dots: true
  ...
  add_action('wp_footer', 'print_gallery_slide_script', 100);
